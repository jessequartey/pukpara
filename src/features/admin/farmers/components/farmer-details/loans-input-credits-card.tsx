...
export function LoansInputCreditsCard(_: LoansInputCreditsCardProps) {
  ...
  const inputCredits: InputCredit[] = [
    {
      ...
      items: [
        { name: "NPK Fertilizer", quantity: 10, unit: "bags", unitPrice: 45.0 },
        { name: "Urea", quantity: 5, unit: "bags", unitPrice: 40.0 },
        { name: "Pesticide", quantity: 2, unit: "liters", unitPrice: 75.0 },
      ],
    },
    {
      id: "2",
      ...
      items: [
        ...
        { name: "Cowpea Seeds", quantity: 10, unit: "kg", unitPrice: 8.0 },
      ],
    },
  ];
  ...
  return (
    <Card>
      ...
      <CardContent>
        <Tabs className="w-full" defaultValue="loans">
          <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger className="flex items-center gap-2" value="loans">
          ...
          <TabsContent className="space-y-4" value="loans">
            {loans.length === 0 ? (
