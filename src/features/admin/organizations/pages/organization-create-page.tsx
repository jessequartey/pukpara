...
export function OrganizationCreatePage() {
	...
	const saveProgress = useOrganizationCreateStore(
		(state) => state.saveProgress,
	);
	const clearProgress = useOrganizationCreateStore(
		(state) => state.clearProgress,
	);
	const hasSavedProgress = useOrganizationCreateStore(
		(state) => state.hasSavedProgress,
	);
	const loadProgress = useOrganizationCreateStore(
	...
	useEffect(() => {
		...
		if (hasSaved) {
			const timestamp = FormPersistence.getSavedTimestamp("ORGANIZATION");
